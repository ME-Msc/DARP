...
| `--time-budget-ms MS` | 否 | 记录到 trace 中的软单步时间预算。 |
...
- 多 state fluent、factored state、随机 observation、完整 POMDP belief carryover、DARP-RDDL 新语法、durative action 原生语法、HILP、HiGHS/Gurobi backend 仍在后续阶段。
